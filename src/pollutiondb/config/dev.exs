...
config :pollutiondb, PollutiondbWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "o21lD20yenHMH84dO0RQsnJVWYixHBpH9NuDmdu8Q4LWXSgHlICCrpQ78tnMDB+b",
  watchers: [
...
config :pollutiondb, PollutiondbWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/pollutiondb_web/(live|views)/.*(ex)$",
      ~r"lib/pollutiondb_web/templates/.*(eex)$"
    ]
  ]
